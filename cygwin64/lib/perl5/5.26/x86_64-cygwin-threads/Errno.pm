...
"x86_64-cygwin-threads-multi-2.9.0(0.31853)" or
	die "Errno architecture (x86_64-cygwin-threads-multi-2.9.0(0.31853)) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
